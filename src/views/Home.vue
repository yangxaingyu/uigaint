  ...
  <div id="sc-banner" class="sc-banner banner-bg position-relative">
    <div class="container">
      <div class="banner-content text-center">
        <img class="banner-icon wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.7s" src="../assets/images/home/icon1.png" alt="icon-image" style="visibility: visible; animation-duration: 0.7s; animation-delay: 0.4s; animation-name: fadeInUp;">
                ...
                <div class="game-price-item active-shape hover-shape-inner">
                  <div class="game-price-inner">
                      ...
                      <div class="price-inner d-flex mb-45  md-mb-20">
                        <div class="image-icon">
                          <a href="project-details.html">
                            <img src="../assets/images/home/ninga-3.png" alt="icon-image">
                          </a>
                        </div>
                    ...
                    <div class="allocation-max text-center">
                      <img src="../assets/images/home/icon-4.png" alt="icon-image">
                  ...
                  <div class="game-price-inner">
                    <div class="total-price">
                      <div class="price-inner d-flex mb-45  md-mb-20">
                        <div class="image-icon">
                          <a href="project-details.html">
                            <img src="../assets/images/home/ninga-4.png" alt="icon-image">
                          </a>
                        </div>
                        <div class="price-details">
                    ...
                    <div class="allocation-max text-center">
                      <img src="../assets/images/home/icon-3.png" alt="icon-image">
                      <div class="allocation">Allocation: 500 BUSD Max</div>
                    </div>
                    <div class="targeted-raise">
                      <div class="all-raise mb-10">Sale End In</div>
                  ...
                  <div class="game-price-inner">
                    <div class="total-price">
                      <div class="price-inner d-flex mb-45 md-mb-20">
                        <div class="image-icon">
                          <a href="project-details.html">
                            <img src="../assets/images/home/ninga-image.png" alt="icon-image">
                          </a>
                        </div>
                        <div class="price-details">
                    ...
                    <div class="allocation-max text-center">
                      <img src="../assets/images/home/icon-2.png" alt="icon-image">
                      <div class="allocation">Allocation: 500 BUSD Max</div>
                    </div>
                    <div class="targeted-raise">
                      <div class="all-raise mb-10">Sale End In</div>
                  ...
                  <div class="game-price-inner">
                    <div class="total-price">
                      <div class="price-inner d-flex mb-45 md-mb-20">
                        <div class="image-icon">
                          <a href="project-details.html">
                            <img src="../assets/images/home/ninga-2.png" alt="icon-image">
                          </a>
                        </div>
                        <div class="price-details">
                    ...
                    <div class="allocation-max text-center">
                      <img src="../assets/images/home/icon-1.png" alt="icon-image">
                      <div class="allocation">Allocation: 500 BUSD Max</div>
                    </div>
                    <div class="targeted-raise">
                      <div class="all-raise mb-10">Sale End In</div>
      ...
      <div class="pt-130 md-pt-80 heading-area align-items-center d-flex justify-content-between wow fadeInUp mb-30" data-wow-delay="0.2s" data-wow-duration="0.4s" style="visibility: hidden; animation-duration: 0.4s; animation-delay: 0.2s; animation-name: none;">
        <div class="sec-heading">
          <div class="sub-inner mb-15">
            ...
            <img class="heading-left-image" src="../assets/images/home/steps.png" alt="Steps-Image">
          </div>
      ...
      <div class="participate-area row">
        <div class="col-lg-4">
          <div class="participate-item d-flex wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.4s" style="visibility: hidden; animation-duration: 0.4s; animation-delay: 0.2s; animation-name: none;">
            <div class="number-image">
              <img src="../assets/images/home/participate-image.png" alt="Participate-Image">
            </div>
        ...
        <div class="col-lg-4">
          <div class="participate-item d-flex wow fadeInUp mr-30" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: hidden; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: none;">
            <div class="number-image">
              <img src="../assets/images/home/participate-image2.png" alt="Participate-Image">
            </div>
            <div class="participate-info">
        ...
        <div class="col-lg-4">
          <div class="participate-item d-flex wow fadeInUp mr-20" data-wow-delay="0.4s" data-wow-duration="0.6s" style="visibility: hidden; animation-duration: 0.6s; animation-delay: 0.4s; animation-name: none;">
            <div class="number-image">
              <img src="../assets/images/home/participate-image3.png" alt="Participate-Image">
            </div>
            <div class="participate-info">
      ...
      <div class="row align-items-center">
        <div class="col-lg-4 col-md-6">
          <div class="project-item hover-shape-border">
            <div class="project-info d-flex">
              <a href="project-details.html">
                <img src="../assets/images/home/project-image.png" alt="Project-Image">
              </a>
            ...
            <div class="project-content">
              <div class="project-header d-flex justify-content-between">
                ...
                <div class="project-icon">
                  <img src="../assets/images/home/project-single-image.png" alt="Project-Image">
                </div>
              </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="project-item hover-shape-border">
            <div class="project-info d-flex">
              <a href="project-details.html">
                <img src="../assets/images/home/project-image2.png" alt="Project-Image">
              </a>
              <div class="project-auother">
            ...
            <div class="project-content">
              <div class="project-header d-flex justify-content-between">
                ...
                <div class="project-icon">
                  <img src="../assets/images/home/project-single-image2.png" alt="Project-Image">
                </div>
              </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="project-item hover-shape-border">
            <div class="project-info d-flex">
              <a href="project-details.html">
                <img src="../assets/images/home/project-image3.png" alt="Project-Image">
              </a>
              <div class="project-auother">
            ...
            <div class="project-content">
              <div class="project-header d-flex justify-content-between">
                ...
                <div class="project-icon">
                  <img src="../assets/images/home/project-single-image3.png" alt="Project-Image">
                </div>
              </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="project-item hover-shape-border">
            <div class="project-info d-flex">
              <a href="project-details.html">
                <img src="../assets/images/home/project-image4.png" alt="Project-Image">
              </a>
              <div class="project-auother">
            ...
            <div class="project-content hover-shape-border">
              <div class="project-header d-flex justify-content-between">
                ...
                <div class="project-icon">
                  <img src="../assets/images/home/project-single-image4.png" alt="Project-Image">
                </div>
              </div>
              <div class="project-media">
                <ul class="project-listing">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="project-item hover-shape-border">
            <div class="project-info d-flex">
              <a href="project-details.html">
                <img src="../assets/images/home/project-image5.png" alt="Project-Image">
              </a>
              <div class="project-auother">
            ...
            <div class="project-content hover-shape-border">
              <div class="project-header d-flex justify-content-between">
                ...
                <div class="project-icon">
                  <img src="../assets/images/home/project-single-image5.png" alt="Project-Image">
                </div>
              </div>
              <div class="project-media">
                <ul class="project-listing">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="project-item hover-shape-border">
            <div class="project-info d-flex">
              <a href="project-details.html">
                <img src="../assets/images/home/project-image6.png" alt="Project-Image">
              </a>
              <div class="project-auother">
            ...
            <div class="project-content">
              <div class="project-header d-flex justify-content-between">
                ...
                <div class="project-icon">
                  <img src="../assets/images/home/project-single-image6.png" alt="Project-Image">
                </div>
              </div>
            ...
            <div class="previous-item hover-shape-border hover-shape-inner">
              <div class="previous-gaming">
                <div class="previous-image">
                  <img src="../assets/images/home/privius-image.png" alt="Previous-Image">
                </div>
              ...
              <div class="previous-chaining">
                <img src="../assets/images/home/previous-image.png" alt="Chain-Image">
        ...
        <div class="col-md-12 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s" style="visibility: hidden; animation-duration: 0.6s; animation-delay: 0.4s; animation-name: none;">
          <a href="project-details.html">
            <div class="previous-item hover-shape-border hover-shape-inner">
              <div class="previous-gaming">
                <div class="previous-image">
                  <img src="../assets/images/home/privius-image2.png" alt="Previous-Image">
                </div>
                <div class="previous-price">
              ...
              <div class="previous-chaining">
                <img src="../assets/images/home/previous-image2.png" alt="Chain-Image">
        ...
        <div class="col-md-12 wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="0.7s" style="visibility: hidden; animation-duration: 0.7s; animation-delay: 0.5s; animation-name: none;">
          <a href="project-details.html">
            <div class="previous-item hover-shape-border hover-shape-inner">
              <div class="previous-gaming">
                <div class="previous-image">
                  <img src="../assets/images/home/privius-image3.png" alt="Previous-Image">
                </div>
                <div class="previous-price">
              ...
              <div class="previous-chaining">
                <img src="../assets/images/home/previous-image3.png" alt="Chain-Image">
                <span>3 Day Ago</span>
              </div>
              <div class="previous-raise">
        ...
        <div class="col-md-12 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="0.8s" style="visibility: hidden; animation-duration: 0.8s; animation-delay: 0.6s; animation-name: none;">
          <a href="project-details.html">
            <div class="previous-item hover-shape-border hover-shape-inner">
              <div class="previous-gaming">
                <div class="previous-image">
                  <img src="../assets/images/home/privius-image4.png" alt="Previous-Image">
                </div>
                <div class="previous-price">
              ...
              <div class="previous-chaining">
                <img src="../assets/images/home/previous-image4.png" alt="Chain-Image">
        ...
        <div class="col-md-12 wow fadeInUp" data-wow-delay="0.7s" data-wow-duration="0.9s" style="visibility: hidden; animation-duration: 0.9s; animation-delay: 0.7s; animation-name: none;">
          <a href="project-details.html">
            <div class="previous-item hover-shape-border hover-shape-inner">
              <div class="previous-gaming">
                <div class="previous-image">
                  <img src="../assets/images/home/privius-image5.png" alt="Previous-Image">
                </div>
                <div class="previous-price">
              ...
              <div class="previous-chaining">
                <img src="../assets/images/home/previous-image5.png" alt="Chain-Image">
    ...
    <div class="container">
      ...
      <div class="gamfi_tokenomics_corner_imgs">
                    <span class="gamfi_tokenomics_corner_img1">
                        <img src="../assets/images/home/RoadMapV2Fram.png" alt="" class="img-fluid">
                    </span>
        <span class="gamfi_tokenomics_corner_img2">
                        <img src="../assets/images/home/RoadMapV2Frame2.png" alt="" class="img-fluid">
                    </span>
      </div>
    </div>
  </div>
  ...
  <div class="gamfi-team-section pt-115 pb-85 md-pt-75 md-pb-42">
    <div class="container">
      <div class="sec-heading text-center mb-55">
        <div class="sub-inner  mb-15">
          <img class="heading-left-image" src="../assets/images/home/steps2.png" alt="Steps-Image">
          <span class="ml-10 mr-10 sub-title">Team Members</span>
          <img class="heading-right-image" src="../assets/images/home/steps.png" alt="Steps-Image">
        </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="team-item text-center active-shape">
            <img src="../assets/images/home/team-image.png" alt="Team-image">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="team-item text-center active-shape">
            <img src="../assets/images/home/team-image2.png" alt="Team-image">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="team-item text-center active-shape">
            <img src="../assets/images/home/team-image3.png" alt="Team-image">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="team-item text-center active-shape">
            <img src="../assets/images/home/team-image4.png" alt="Team-image">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="team-item text-center active-shape">
            <img src="../assets/images/home/team-image5.png" alt="Team-image">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="team-item text-center active-shape">
            <img src="../assets/images/home/team-image6.png" alt="Team-image">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="team-item text-center active-shape">
            <img src="../assets/images/home/team-image7.png" alt="Team-image">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="team-item text-center active-shape">
            <img src="../assets/images/home/team-image8.png" alt="Team-image">
    ...
    <div class="container">
      <div class="sec-heading text-center wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.4s" style="visibility: hidden; animation-duration: 0.4s; animation-delay: 0.2s; animation-name: none;">
        <div class="sub-inner mb-55">
          <img class="heading-right-image" src="../assets/images/home/steps2.png" alt="Steps-Image">
      ...
      <div class="gamfi-partner-inner wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.4s" style="visibility: hidden; animation-duration: 0.4s; animation-delay: 0.2s; animation-name: none;">
        <div class="partner-image">
          <a href="#">
            <img src="../assets/images/home/partner-image.png" alt="Partner-Image">
          </a>
          <a href="#">
            <img src="../assets/images/home/partner-image2.png" alt="Partner-Image">
          </a>
          <a href="#">
            <img src="../assets/images/home/partner-image3.png" alt="Partner-Image">
          </a>
          <a href="#">
            <img src="../assets/images/home/partner-image4.png" alt="Partner-Image">
          </a>
          <a href="#">
            <img src="../assets/images/home/partner-image5.png" alt="Partner-Image">
          </a>
          <a href="#">
            <img src="../assets/images/home/partner-image6.png" alt="Partner-Image">
          </a>
        </div>
        <div class="partner-image">
          <a href="#">
            ...
            <ul class="heading-list">
              <li>
                <a href="#" class="connect-meta">
                                        <span>
                                            <img src="../assets/images/home/meta-mask.png" alt="Meta-mask-Image">
                                        </span>
                  MetaMask
                </a>
              </li>
              <li>
                <a href="#">
                                        <span>
                                            <img src="../assets/images/home/coinbase.png" alt="Coinbase-Image">
                                        </span>
                  Coinbase
                </a>
              </li>
              <li>
                <a href="#">
                                        <span>
                                            <img src="../assets/images/home/trust.png" alt="Trust-Image">
                                        </span>
                  Trust Wallet
                </a>
              </li>
              <li>
                <a href="#">
                                        <span>
                                            <img src="../assets/images/home/wallet.png" alt="Wallet-Image">
                                        </span>
                  WalletConnect
                </a>
              </li>
